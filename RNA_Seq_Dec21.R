...
require(ggplot2)
ggplot(totlog, aes(cd4_pandemrix.tpm, cd4_control.tpm, label = totlog$gene_id))+geom_point(alpha = 1/5)+xlim(-20, 10)+ylim(-20, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd8_pandemrix.tpm), log(cd8_control.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd19_pandemrix.tpm), log(cd19_control.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd14_pandemrix.tpm), log(cd14_control.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(nk_pandemrix.tpm), log(nk_control.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd8_pandemrix.tpm), log(cd4_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd19_pandemrix.tpm), log(cd14_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd19_pandemrix.tpm), log(cd4_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(nk_pandemrix.tpm), log(cd4_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(nk_pandemrix.tpm), log(cd14_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
ggplot(tot_log, aes(log(cd8_pandemrix.tpm), log(cd4_pandemrix.tpm), label = rownames(tot_log)))+geom_point(alpha = 1/5)+xlim(-10, 10)+ylim(-10, 10)+geom_text(angle=60, check_overlap = T, hjust = -0.2, nudge_x = 0.1)+theme(axis.text.x = element_text(size = 15), axis.text.y = element_text(size =15), axis.title.x = element_text(size = 18, face = "bold"), axis.title.y = element_text(size = 18, face = "bold"))
